<?php
    ...
    function getStoredPassword($username) {
        try {
            ...
            $passwordQuery = $connection->prepare('SELECT PASSWORD FROM ' . USER_CREDENTIAL_TABLE . ' WHERE EMAIL = :username');
    ...
    function submitPassword($username, $newPassword) {
        try {
            ...
            $accountInformationUpdate = $connection->prepare('UPDATE ' . USER_CREDENTIAL_TABLE . ' SET PASSWORD = :newPassword WHERE EMAIL = :username');
